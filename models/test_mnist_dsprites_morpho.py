...
class VAE(pl.LightningModule):
    def __init__(self, conf:dict, *args, **kwargs):
        ...
        if (self.used_data == 'morpho'):
            ...
            self.fc12 = nn.Linear(in_features=200, out_features=200)  # input
    ...
    def train_dataloader(self):
        ...
        if(self.used_data == 'morpho'):
            ...
            MORPHO_MNIST_FILE_TRAIN_Y = "./models/output_dir/pm-pert-idx1-ubyte.gz"
            MORPHO_MNIST_FILE_TRAIN_X = "./models/output_dir/pm-images-idx3-ubyte.gz"
            # self.train_dataset = morpho_utils.load_idx(MORPHO_MNIST_FILE_TRAIN_X)[:9000]
            self.train_dataset = morpho_io.load_idx(MORPHO_MNIST_FILE_TRAIN_X)[:9000]
            # self.train_y = morpho_utils.load_idx(MORPHO_MNIST_FILE_TRAIN_Y)[:9000]
    ...
    def test_dataloader(self):
        ...
        if(self.used_data == 'morpho'):
            MORPHO_MNIST_FILE_TEST_Y = "./models/output_dir/pm-pert-idx1-ubyte.gz"
            MORPHO_MNIST_FILE_TEST_X = "./models/output_dir/pm-images-idx3-ubyte.gz"
            # self.test_dataset = morpho_utils.load_idx(MORPHO_MNIST_FILE_TEST_X)[9500:10000]
            self.test_dataset = morpho_io.load_idx(MORPHO_MNIST_FILE_TEST_X)[9500:10000]
            # self.test_y = morpho_utils.load_idx(MORPHO_MNIST_FILE_TEST_Y)[9500:10000]
            self.test_y = morpho_io.load_idx(MORPHO_MNIST_FILE_TEST_Y)[9500:10000]
        elif(self.used_data == 'dsprites'):
    ...
    for epoch in ls_epochs:
        for lf in ls_latent_factors:
            ...
            for beta in ls_betas:
                ...
                exp_name =  "rkld_{}_data_{}_beta_{}_epochs_{}_lf_synt_{}_normal_{}_continous_{}_hessian_{}".format(used_data, beta, epoch, lf, synthetic_data, normalvariate, continous_data, is_hessian_penalty_activated)
                ...
                if(train==False):
                    ...
                    # model_path = base_curated_test_path + "rkld_morpho_data_4_beta_20_epochs_64_lf.ckpt"
                    ...
                    # model_path = base_curated_test_path + "rkld_morpho_data_4_beta_2_epochs_10_lf_synt_True_normal_False_continous_False_hessian_False.ckpt"
                    # model_path = base_curated_test_path + "rkld_morpho_data_0.01_beta_20_epochs_10_lf_synt_True_normal_False_continous_False_hessian_False.ckpt"
                    # model_path = base_curated_test_path + "rkld_morpho_data_0.01_beta_60_epochs_10_lf_synt_True_normal_False_continous_False_hessian_False.ckpt"
                    # model_path = base_curated_test_path + "rkld_morpho_data_0.012755102040816327_beta_100_epochs_10_lf_synt_True_normal_False_continous_False_hessian_False.ckpt"
                    # model_path = base_curated_test_path + "rkld_morpho_data_0.012_beta_100_epochs_10_lf_synt_True_normal_False_continous_False_hessian_False.ckpt"
                    ...
                    # attribute_path = base_curated_test_path + "rkld_morpho_data_4_beta_20_epochs_64_lf.pickle"
                    ...
                    # attribute_path = base_curated_test_path + "rkld_morpho_data_4_beta_2_epochs_10_lf_synt_True_normal_False_continous_False_hessian_False_attributes.pickle"
                    # attribute_path = base_curated_test_path + "rkld_morpho_data_0.01_beta_20_epochs_10_lf_synt_True_normal_False_continous_False_hessian_False_attributes.pickle"
                    # attribute_path = base_curated_test_path + "rkld_morpho_data_0.01_beta_60_epochs_10_lf_synt_True_normal_False_continous_False_hessian_False_attributes.pickle"
                    # attribute_path = base_curated_test_path + "rkld_morpho_data_0.012755102040816327_beta_100_epochs_10_lf_synt_True_normal_False_continous_False_hessian_False_attributes.pickle"
                    # attribute_path = base_curated_test_path + "rkld_morpho_data_0.012_beta_100_epochs_10_lf_synt_True_normal_False_continous_False_hessian_False_attributes.pickle"
                    ...
                    # Sample
                        ...
                        save_image(sample.view(64, 1, 28, 28), './results/mnist_imgs/sample_morpho_20_2' + '.png')
                    else:
                        lf = 10
                        z = torch.randn(64, lf)
                        sample = test_model.decode(z)
                        save_image(sample.view(64, 1, 64, 64), './results/mnist_imgs/sample_dsprite_20_mse' + '.png')
